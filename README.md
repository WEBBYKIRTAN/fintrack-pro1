...
Right-click register.html (or login.html if you already have an account) and choose "Open with Live Server".
Register a username/password, then log in.
You'll land on index.html — the dashboard.
